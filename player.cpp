...
void Player::shoot(enum spritesDirection d){
	switch(d){
		case NORTH:
			upBullet.shoot("up", getPosition() + Vector2f(60, 0), Vector2f(0, -400 + velocityY()), d);
			break;
		case SOURTH:
			downBullet.shoot("down", getPosition() + Vector2f(60, 60), Vector2f(0, 400 + velocityY()), d);
			break;
		case WEST:
			leftBullet.shoot("left", getPosition() + Vector2f(20, 60), Vector2f(-400 + velocityX(), 0), d);
			break;
		case EAST:
			rightBullet.shoot("right", getPosition() + Vector2f(120, 60), Vector2f(400 + velocityX(), 0), d);
			break;
		default:
			break;
	}
...
bool Player::collisionDetect(const Drawable* d){
...
void Player::update(Uint32 ticks, bool isPaused){
...
void Player::makeChange(enum spritesDirection newDir, enum spritesDirection counterDir, double vx, double vy){
