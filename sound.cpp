  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/back.wav");
  ...
  sounds.push_back( Mix_LoadWAV("sound/hurt.wav") );
  sounds.push_back( Mix_LoadWAV("sound/canno.wav") );
...
void SDLSound::startMusic() const{
  Mix_VolumeMusic(volume);
  Mix_PlayMusic(music, -1);
}

void SDLSound::stopMusic() const{
  Mix_HaltMusic();
}
